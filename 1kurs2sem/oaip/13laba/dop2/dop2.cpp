...
void printLevel(Tree* t, int level, int& count)
{
    if (t == nullptr) return;

    if (level == 0)
    {
        cout << "Ключ: " << t->key << " Слово: ";
        puts(t->text);
        count++;
        return;
    }
...
int main()
{
    ...
    for (;;)
    {
        ...
        cout << "4 - вывод дерева\n";
        cout << "5 - определения числа ветвей n-го уровня этого дерева и вывода этих элементов на экран\n";
        ...
        case 5:
        {
            ...
            cout << "Элементы уровня " << n << ":\n";
            printLevel(root, n, count);
